    ...
    <div className='App'>
      <div className='bigContainer'>
        <div
          ...
          style={{ display: countdown ? 'block' : 'none' }}
        >
          <div
            className='countdownTimer'
            style={{
              display: counter > 25 ? 'block' : 'none',
              opacity: counter === 35 ? '1' : '.5',
            }}
          >
            3
          </div>
          <div
            className='countdownTimer'
            style={{
              display: counter <= 25 && counter > 15 ? 'block' : 'none',
              opacity: counter === 25 ? '1' : '.5',
            }}
          >
            2
          </div>
          <div
            className='countdownTimer'
            style={{
              display: counter <= 15 && counter > 5 ? 'block' : 'none',
              opacity: counter === 15 ? '1' : '.5',
            }}
          >
            1
          </div>
        ...
        >
          <div className='dropStart'>
            ...
            <button className='startBtn' onClick={closeStart}>
              Start
            </button>
